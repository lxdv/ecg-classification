...
from models.models_2d import HeartNet, MobileNetV2, AlexNet, VGG16bn, ResNet, ShuffleNet, EfficientNet
...
class Trainer2D(BaseTrainer):
    ...
    def _init_net(self):
        model = EfficientNet(num_classes=self.config['num_classes'])
